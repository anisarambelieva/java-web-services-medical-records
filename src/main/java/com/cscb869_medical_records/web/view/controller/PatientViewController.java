...
import com.cscb869_medical_records.web.view.controller.model.patient.PatientInfoViewModel;
...
public class PatientViewController {
    ...
    public String viewPatientInfo(@PathVariable Long id, Model model) {
        ...
        List<String> sickLeaves = patientService.getSickLeaves(id); // Fetch sick leaves
