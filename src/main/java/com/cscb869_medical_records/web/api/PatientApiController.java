...
public class PatientApiController {
    ...
    public List<Patient> getAllByDiagnosisNameContains(@PathVariable String diagnosisName) {
        return this.patientService.getAllByDiagnosisNameContains(diagnosisName);
    }
}
